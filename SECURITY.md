...
The Agent Directory Importer project team welcomes security reports and is committed to
...
users of Agent Directory Importer, and maintainers of upstream dependencies if applicable.

Downstream project maintainers and Agent Directory Importer users can request participation in
...
Participation in security issue coordination processes is at the discretion of the Agent Directory Importer team.

## Security advisories

The project team is committed to transparency in the security issue disclosure
process. The Agent Directory Importer team announces security issues via [project GitHub Release notes](https://github.com/agtncy/dir/releases).
